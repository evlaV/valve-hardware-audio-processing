...
all: clean
	...
	( export CXX=$(FAUST_COMPILER) \
	  export CXXFLAGS="$${CXXFLAGS} -Itemp_includes "; \
	  faust2lv2 src/faust/valve_deck_speakers.dsp && \
	  faust2lv2 src/faust/valve_binaural.dsp      && \
	  faust2lv2 src/faust/valve_deck_microphone.dsp)
