...
INSTALL_DIR="${INSTALL_DIR:-$DEST_DIR/usr/lib/lv2}"
...
mkdir -p "$INSTALL_DIR"
cp -r bin/lv2/g++/valve_deck_speakers.lv2 "$INSTALL_DIR"/valve_deck_speakers.lv2
cp -r bin/lv2/g++/valve_binaural.lv2 "$INSTALL_DIR"/valve_binaural.lv2
cp -r bin/lv2/g++/valve_deck_microphone.lv2 "$INSTALL_DIR"/valve_deck_microphone.dsp
